...
public class PHItemRegistry {
    ...
    public static final DeferredItem<Item> NET_ITEM = DEF_REG.register("net", () -> new NetItem(Type.EMPTY));
    public static final DeferredItem<Item> NET_HAS_ITEM = DEF_REG.register("net_has_item", () -> new NetItem(Type.HAS_MOB));
    public static final DeferredItem<Item> NET_LAUNCHER_ITEM = DEF_REG.register("net_launcher", () -> new NetLauncherItem(new Item.Properties().durability(60)));
}
